...
require '../includes/values-register-accounts.php';
...
<head>
    ...
    <title>Battle Games | Suscribirse</title>
</head>
<body>
            ...
            <div class="row justify-content-center">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-5">
                    <form action="" method="post" autocomplete="off" class="form-card">
                        ...
                        <div class="form-card-input"><input name="username" type="text" placeholder="Nom.usuario" required></div>
                        ...
                        <div class="form-card-input"><button name="bt-create-account">Suscribirse</button></div>
                        <div class="enlace-http"><p>¿Ya tienes una cuenta? <span class="span-element"><a href="../public/login.php">Inicia sesion</a></span></p></div>
